...
document.getElementById("service-previous").onclick = function(){
    ...
    document.getElementById('service-title').innerHTML = 
      our_services[servico_anterior].title;

    document.getElementById('service-text').innerHTML = 
      our_services[servico_anterior].text;
...
document.getElementById("service-next").onclick = function(){
  ...
  document.getElementById('service-title').innerHTML = 
    our_services[servico_seguinte].title;

  document.getElementById('service-text').innerHTML = 
    our_services[servico_seguinte].text;
...
var data = new Date;
console.log(data);
document.getElementById("current_year").innerHTML =  data.getFullYear(); 
